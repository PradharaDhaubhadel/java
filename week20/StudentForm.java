...
public class StudentForm extends JFrame implements ActionListener //ACtionlistner is interface
{
    //variable must be defined at instance level
    ...
    public StudentForm()
    {
        ...
        clearFormBtn.addActionListener(new ActionListener()//anamous class
        {
            @Override 
    ...
    public void handleSubmit(){
        ...
        //readBox, travelBox, sportBox
        if(readBox.isSelected())
        {
            hobbiesList.add(readBox.getText());
        }
        else if(travelBox.isSelected())
        {
